...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100094149753967')
...
\033[1;32m----------------
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ KISHOR MGR ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  KISHOR_XD
❣︎[𖣘]☔︎ FB NAME     :  KISHOR MAGAR
❣︎[𖣘]☔︎ON GITHUB    :  KISHOR_XD
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[KISHOR-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
